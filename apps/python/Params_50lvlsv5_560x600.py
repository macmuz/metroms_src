...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_new_hmask_25_initial.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['NLEVELS',"25"],  #Could read from grd-file?
            ['GRDTHETAS',"1.0"],
            ['GRDTHETAB',"1.5"],
            ['GRDTCLINE',"30.0"],            
            ['_TNU2_',"0.0d0  0.0d0"],
            ...
            ['OBCFAKTOR',"2.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_125NM_new_hmask_25.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_new_hmask_25_1998_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_new_hmask_25_1999_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_new_hmask_25_2000_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_new_hmask_25_bc_obs_zetav3_1998.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_new_hmask_25_bc_obs_zetav3_1999.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_new_hmask_25_bc_obs_zetav3_2000.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1992"],
            ['CICEGRD',"CICE_grid_125NM_new_hmask.nc"],
            ['CICEKMT',"CICE_KMT_125NM_new_hmask.nc"],
            ['CICEBAT',"CICE_bathy_125NM_new_hmask.nc"],
            ]
            ########################################################################
            ########################################################################
        else:
