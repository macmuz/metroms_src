...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_05NM_aprilv2_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ########################################################################
            self.KEYWORDLIST=[
            ['APPTITLE',"ROMS 1087 - baltic 0.5 NM - Coupled ROMS-CICE"],
            ['MYAPPCPPNAME',"BALTIC"],
            ...
            ['OBCFAKTOR',"10.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_05NM_aprilv2.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_05NM_aprilv2_1992_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_05NM_aprilv2_1993_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_05NM_aprilv2_1994_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_05NM_aprilv2_1995_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_aprilv2_bc_obs_zetav5_1992.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_aprilv2_bc_obs_zetav5_1993.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_aprilv2_bc_obs_zetav5_1994.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_aprilv2_bc_obs_zetav5_1995.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1992"],
            ['CICEGRD',"CICE_grid_05NM_aprilv2.nc"],
            ['CICEKMT',"CICE_KMT_05NM_aprilv2.nc"],
            ['CICEBAT',"CICE_bathy_05NM_aprilv2.nc"],
            ]
            ########################################################################
            ########################################################################
        else:
