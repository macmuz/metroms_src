...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_filter_initial.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"10.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_filter.nc"],
            ...
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_filter_bc_spline_2016.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_filter_bc_spline_2017.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_filter_bc_spline_2018.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_filter_bc_spline_2019.nc"],
            ...
            ['CICEKTENS',"0.6"],
            ['CICEFYEAR',"1993"],
            ['CICEGRD',"CICE_grid_1370x1460_south_filter.nc"],
            ['CICEKMT',"CICE_KMT_1370x1460_south_filter.nc"],
            ['CICEBAT',"CICE_bathy_1370x1460_south_filter.nc"],
            ]
            ########################################################################
            ########################################################################
        else:
