...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINFOLDER="/users/project1/pt00972/CSDIR/input_october"
            self.ROMSFORCING="/users/project1/pt00972/CSDIR/forcing_560x600_UERRA"
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_october2_19930102_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['NLEVELS',"40"],  #Could read from grd-file?
            ['GRDTHETAS',"0.0d0"],
            ['GRDTHETAB',"0.0d0"],
            ['GRDTCLINE',"1.0d17"],            
            ['_TNU2_',"0.0d2  0.0d2"],
            ...
            ['OBCFAKTOR',"1.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_125NM_october2.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_october2_vertical_1993_Lw.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_october2_vertical_1994_Lw.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_october2_vertical_1995_Lw.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_october2_bc_bar_sla_1993.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_october2_bc_bar_sla_1994.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_october2_bc_bar_sla_1995.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1993"],
            ['CICEGRD',"CICE_grid_october.nc"],
            ['CICEKMT',"CICE_KMT_october.nc"],
            ['CICEBAT',"CICE_bathy_october.nc"],
