...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_old_grid_560x600_50v2_19930102_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"1.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_old_grid_560x600_50v2.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_old_grid_50v2_1998_Lw.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_old_grid_50v2_1999_Lw.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_old_grid_50v2_2000_Lw.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_old_grid_560x600_50v2_bc_bar_sla_1998.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_old_grid_560x600_50v2_bc_bar_sla_1999.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_old_grid_560x600_50v2_bc_bar_sla_2000.nc"],
