...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_smooth_19930102_initial_full2.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"1.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_125NM_smooth.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_smooth_vertical_1993_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_smooth_vertical_1994_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_smooth_vertical_1995_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_smooth_bc_bar_1993.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_smooth_bc_bar_1994.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_smooth_bc_bar_1995.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1992"],
            ['CICEGRD',"CICE_grid_125NM_smooth.nc"],
            ['CICEKMT',"CICE_KMT_125NM_smooth.nc"],
            ['CICEBAT',"CICE_bathy_125NM_smooth.nc"],
