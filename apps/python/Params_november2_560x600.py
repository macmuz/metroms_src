...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINFOLDER="/users/project1/pt00972/CSDIR/input_november"
            self.ROMSFORCING="/users/project1/pt00972/CSDIR/forcing_560x600_UERRA"
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_november2_19930102_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"1.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_125NM_november2.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_november2_1993_Lw.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_november2_1994_Lw.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_november2_1995_Lw.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_november2_bc_bar_sla_1993.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_november2_bc_bar_sla_1994.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_november2_bc_bar_sla_1995.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1993"],
            ['CICEGRD',"CICE_grid_november2.nc"],
            ['CICEKMT',"CICE_KMT_november2.nc"],
            ['CICEBAT',"CICE_bathy_november2.nc"],
