...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINFOLDER="/users/work/mmuzyka/CSDIR/input_new_hmask"
            self.ROMSFORCING="/users/work/mmuzyka/CSDIR/forcing_560x600"
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_05NM_new_hmask_initial_full.nc"
            if restart == True:
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"10.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_05NM_new_hmask.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_05NM_1992.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_05NM_1993.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_05NM_1994.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_05NM_1995.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_05NM_1996.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_new_hmask_bc_obs_zeta_1992.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_new_hmask_bc_obs_zeta_1993.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_new_hmask_bc_obs_zeta_1994.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_new_hmask_bc_obs_zeta_1995.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_new_hmask_bc_obs_zeta_1996.nc"],
            ...
            ['ATMDIR',\
                ...
                self.ROMSFORCING+"/baltic_Pair_1992.nc | \n"+\
                ...
                self.ROMSFORCING+"/baltic_Qair_1992.nc | \n"+\
                ...
                self.ROMSFORCING+"/baltic_rain_1992.nc | \n"+\
                ...
                self.ROMSFORCING+"/baltic_swrad_1992.nc | \n"+\
                ...
                self.ROMSFORCING+"/baltic_Tair_1992.nc | \n"+\
                ...
                self.ROMSFORCING+"/baltic_wind_1992.nc | \n"+\
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1992"],
            ['CICEGRD',"CICE_grid_05NM_new_hmask.nc"],
            ['CICEKMT',"CICE_KMT_05NM_new_hmask.nc"],
            ['CICEBAT',"CICE_bathy_05NM_new_hmask.nc"],
            ]
            ########################################################################
            ########################################################################
        else:
