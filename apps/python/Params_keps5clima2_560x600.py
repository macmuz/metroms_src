...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2012_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2013_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2014_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2012.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2013.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2014.nc"],
            ['_CLMNAME_',\
                self.ROMSINFOLDER+"/ROMS_clima_2012.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_clima_2013.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_clima_2014.nc"],
            ['_NUDNAME_',\
                self.ROMSINFOLDER+"/ROMS_nud.nc"],
