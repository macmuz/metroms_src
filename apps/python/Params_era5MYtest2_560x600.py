...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINFOLDER="/users/project1/pt00972/CSDIR/input_560x600"
            self.ROMSFORCING="/users/project1/pt00972/CSDIR/forcing_560x600"
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_may2_19930102_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"1.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_125NM_may2.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_may2_vertical_1993_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_may2_vertical_1994_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_may2_vertical_1995_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_may2_bc_bar_sla_1993.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_may2_bc_bar_sla_1994.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_may2_bc_bar_sla_1995.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1992"],
            ['CICEGRD',"CICE_grid_125NM_may2.nc"],
            ['CICEKMT',"CICE_KMT_125NM_may2.nc"],
            ['CICEBAT',"CICE_bathy_125NM_may2.nc"],
