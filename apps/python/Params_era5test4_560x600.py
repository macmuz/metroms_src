...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_april_initial.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"2.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_125NM_april.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_april_1999_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_april_2000_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_april_2001_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_april_2002_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_april_2003_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_april_bc_obs_zetav5_1999.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_april_bc_obs_zetav5_2000.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_april_bc_obs_zetav5_2001.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_april_bc_obs_zetav5_2002.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_april_bc_obs_zetav5_2003.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1992"],
            ['CICEGRD',"CICE_grid_125NM_april.nc"],
            ['CICEKMT',"CICE_KMT_125NM_april.nc"],
            ['CICEBAT',"CICE_bathy_125NM_april.nc"],
            ]
            ########################################################################
            ########################################################################
        else:
