...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['AVGSTEPP',str(1*3600/int(self.DELTAT))],
            ['STARTAVG',"1"],
            ...
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2014_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2015_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2016_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2017_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2014.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2015.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2016.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2017.nc"],
            ['_CLMNAME_',\
                self.ROMSINFOLDER+"/ROMS_clima_2014.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_clima_2015.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_clima_2016.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_clima_2017.nc"],
            ['_NUDNAME_',\
            ...
            ['ATMDIR',\
                ...
                self.ROMSFORCING+"/baltic_cloud_2014.nc | \n"+\
                self.ROMSFORCING+"/baltic_cloud_2015.nc | \n"+\
                self.ROMSFORCING+"/baltic_cloud_2016.nc | \n"+\
                self.ROMSFORCING+"/baltic_cloud_2017.nc \ \n"+\
