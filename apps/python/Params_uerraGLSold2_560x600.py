...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_2_3km_560x600_NetCDF4_19930102_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['CICEINTERP',"/users/work/mmuzyka/CSDIR/input_560x600/out_1_25NM.nc"],
            ]
            ########################################################################
            ########################################################################
        else:
