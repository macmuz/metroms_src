...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_05NM_015_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"1.0"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south.nc"],
            ...
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_bc_spline_2016.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_bc_spline_2017.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_bc_spline_2018.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_05NM_015_south_bc_spline_2019.nc"],
