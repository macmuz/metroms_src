...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSFORCING="/users/project1/pt00625/CSDIR/forcing_560x600"
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_19930102_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['OBCFAKTOR',"0.8"],
            ['NUDGZONEWIDTH',"10"],
            ['GRDFILE',self.ROMSINFOLDER+"/ROMS_grid_125NM_dec.nc"],
            ['INIFILE',self.ROMSINIRST],
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_1999_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2000_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2001_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_dec_vertical_2002_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_1999.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2000.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2001.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_dec_bc_bar_spline_2002.nc"],
            ...
            ['CICEKTENS',"0.2"],
            ['CICEFYEAR',"1992"],
            ['CICEGRD',"CICE_grid_125NM_dec.nc"],
            ['CICEKMT',"CICE_KMT_125NM_dec.nc"],
            ['CICEBAT',"CICE_bathy_125NM_dec.nc"],
