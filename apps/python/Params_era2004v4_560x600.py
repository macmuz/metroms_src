...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINIFILE = self.ROMSINFOLDER+"/ROMS_grid_125NM_april_2003_initial_full.nc"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['RIVERFILE',\
                ...
                self.ROMSINFOLDER+"/rivers_125NM_april_2004_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_april_bc_bar_2003.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_april_bc_bar_2004.nc"],
