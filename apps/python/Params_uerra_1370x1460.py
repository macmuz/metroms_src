...
class Params(object):
    ...
    def __init__(self,app,xcpu,ycpu,start_date,end_date,nrrec=0,cicecpu=0,restart=False,copy=True):
        ...
        if app=='baltic':
            ...
            self.ROMSINFOLDER="/users/work/mmuzyka/CSDIR/input_long"
...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_1470x1360x26_1992_vshape3.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_1470x1360x26_1993_vshape3.nc | \n"+\
