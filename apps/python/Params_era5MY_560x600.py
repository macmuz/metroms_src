...
#                cice_ic = self.CICERUNDIR+"/restart/iced.1999-11-27-00000.nc"
            ...
            ['RUNDIR',self.RUNPATH],
            ['RIVERFILE',\
                self.ROMSINFOLDER+"/rivers_125NM_may_1995_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_may_1996_Luv.nc | \n"+\
                self.ROMSINFOLDER+"/rivers_125NM_may_1997_Luv.nc"],
            ['_BRYNAME_',\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_may_bc_bar_1995.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_may_bc_bar_1996.nc | \n"+\
                self.ROMSINFOLDER+"/ROMS_grid_125NM_may_bc_bar_1997.nc"],
