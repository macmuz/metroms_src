...
export METROMS_CASEDIR=/users/project1/pt00625/CSDIR/metro_560x600_clean
#######################################
...
export METROMS_FORCING=/users/project1/pt00625/CSDIR/forcing_560x600_CERRA
