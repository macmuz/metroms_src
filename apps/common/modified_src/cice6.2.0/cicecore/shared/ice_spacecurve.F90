...
! !USES:
   ...
   use ice_fileunits, only: ice_stdout, ice_stderr, flush_fileunit ! note these might be the same
...
!-----------------------------------------------------------------------
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,21) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,22) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,23) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,24) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,25) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,26) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,27) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,28) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,29) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,30) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,31) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,32) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,33) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,34) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,35) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,36) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,37) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,38) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,39) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,40) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,41) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,42) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,43) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,44) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
     ...
     if(ll .gt. 1) then
        if(debug) write(ice_stdout,45) ll-1,pos(0),pos(1),lma,lmd,lja,ljd
        ierr  = GenCurve(ll-1,ltype,lma,lmd,lja,ljd)
        if(debug) call PrintCurve(ordered)
     else
        ierr = IncrementCurve(lja,ljd)
...
!JMD      print *,'Matchfactor: found value: ',val1
   ...
   subroutine PrintFactor(msg,fac)
      ...
      write(ice_stdout,*) subname,' '
      write(ice_stdout,*) subname,'msg = ',trim(msg)
      write(ice_stdout,*) subname,(fac%factors(i),i=1,fac%numfact)
      write(ice_stdout,*) subname,(fac%used(i),i=1,fac%numfact)
...
!-----------------------------------------------------------------------
     ...
     if(gridsize == 2) then
        write (ice_stdout,*) "A Level 1 Hilbert Curve:"
        write (ice_stdout,*) "------------------------"
        do i=1,gridsize
           write(ice_stdout,2) Mesh(1,i),Mesh(2,i)
        enddo
     else if(gridsize == 3) then
        write (ice_stdout,*) "A Level 1 Peano Meandering Curve:"
        write (ice_stdout,*) "---------------------------------"
        do i=1,gridsize
           write(ice_stdout,3) Mesh(1,i),Mesh(2,i),Mesh(3,i)
        enddo
     else if(gridsize == 4) then
        write (ice_stdout,*) "A Level 2 Hilbert Curve:"
        write (ice_stdout,*) "------------------------"
        do i=1,gridsize
           write(ice_stdout,4) Mesh(1,i),Mesh(2,i),Mesh(3,i),Mesh(4,i)
        enddo
     else if(gridsize == 5) then
        write (ice_stdout,*) "A Level 1 Cinco Curve:"
        write (ice_stdout,*) "------------------------"
        do i=1,gridsize
           write(ice_stdout,5) Mesh(1,i),Mesh(2,i),Mesh(3,i),Mesh(4,i),Mesh(5,i)
        enddo
     else if(gridsize == 6) then
        write (ice_stdout,*) "A Level 1 Hilbert and Level 1 Peano Curve:"
        write (ice_stdout,*) "------------------------------------------"
        do i=1,gridsize
           write(ice_stdout,6) Mesh(1,i),Mesh(2,i),Mesh(3,i), &
                      Mesh(4,i),Mesh(5,i),Mesh(6,i)
        enddo
     else if(gridsize == 8) then
        write (ice_stdout,*) "A Level 3 Hilbert Curve:"
        write (ice_stdout,*) "------------------------"
        do i=1,gridsize
           write(ice_stdout,8) Mesh(1,i),Mesh(2,i),Mesh(3,i),Mesh(4,i), &
                      Mesh(5,i),Mesh(6,i),Mesh(7,i),Mesh(8,i)
         enddo
     else if(gridsize == 9) then
        write (ice_stdout,*) "A Level 2 Peano Meandering Curve:"
        write (ice_stdout,*) "---------------------------------"
        do i=1,gridsize
           write(ice_stdout,9) Mesh(1,i),Mesh(2,i),Mesh(3,i),Mesh(4,i), &
                      Mesh(5,i),Mesh(6,i),Mesh(7,i),Mesh(8,i), &
                      Mesh(9,i)
         enddo
     else if(gridsize == 10) then
        write (ice_stdout,*) "A Level 1 Hilbert and Level 1 Cinco Curve:"
        write (ice_stdout,*) "---------------------------------"
        do i=1,gridsize
           write(ice_stdout,10) Mesh(1,i),Mesh(2,i),Mesh(3,i),Mesh(4,i), &
                      Mesh(5,i),Mesh(6,i),Mesh(7,i),Mesh(8,i), &
                      Mesh(9,i),Mesh(10,i)
         enddo
     else if(gridsize == 12) then
        write (ice_stdout,*) "A Level 2 Hilbert and Level 1 Peano Curve:"
        write (ice_stdout,*) "------------------------------------------"
        do i=1,gridsize
           write(ice_stdout,12) Mesh(1,i),Mesh(2,i), Mesh(3,i), Mesh(4,i), &
                       Mesh(5,i),Mesh(6,i), Mesh(7,i), Mesh(8,i), &
                       Mesh(9,i),Mesh(10,i),Mesh(11,i),Mesh(12,i)
        enddo
     else if(gridsize == 15) then
        write (ice_stdout,*) "A Level 1 Peano and Level 1 Cinco Curve:"
        write (ice_stdout,*) "------------------------"
        do i=1,gridsize
           write(ice_stdout,15) Mesh(1,i),Mesh(2,i),Mesh(3,i),Mesh(4,i), &
                       Mesh(5,i),Mesh(6,i),Mesh(7,i),Mesh(8,i), &
                       Mesh(9,i),Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i)
        enddo
     else if(gridsize == 16) then
        write (ice_stdout,*) "A Level 4 Hilbert Curve:"
        write (ice_stdout,*) "------------------------"
        do i=1,gridsize
           write(ice_stdout,16) Mesh(1,i),Mesh(2,i),Mesh(3,i),Mesh(4,i), &
                       Mesh(5,i),Mesh(6,i),Mesh(7,i),Mesh(8,i), &
                       Mesh(9,i),Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i),Mesh(16,i)
        enddo
     else if(gridsize == 18) then
        write (ice_stdout,*) "A Level 1 Hilbert and Level 2 Peano Curve:"
        write (ice_stdout,*) "------------------------------------------"
        do i=1,gridsize
           write(ice_stdout,18) Mesh(1,i), Mesh(2,i), Mesh(3,i), Mesh(4,i), &
                       Mesh(5,i), Mesh(6,i), Mesh(7,i), Mesh(8,i), &
                       Mesh(9,i), Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i),Mesh(16,i), &
                       Mesh(17,i),Mesh(18,i)
        ...
        write (ice_stdout,*) "A Level 2 Hilbert and Level 1 Cinco Curve:"
        write (ice_stdout,*) "------------------------------------------"
        do i=1,gridsize
           write(ice_stdout,20) Mesh(1,i), Mesh(2,i), Mesh(3,i), Mesh(4,i), &
                       Mesh(5,i), Mesh(6,i), Mesh(7,i), Mesh(8,i), &
                       Mesh(9,i), Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i),Mesh(16,i), &
        ...
        write (ice_stdout,*) "A Level 3 Hilbert and Level 1 Peano Curve:"
        write (ice_stdout,*) "------------------------------------------"
        do i=1,gridsize
           write(ice_stdout,24) Mesh(1,i), Mesh(2,i), Mesh(3,i), Mesh(4,i), &
                       Mesh(5,i), Mesh(6,i), Mesh(7,i), Mesh(8,i), &
                       Mesh(9,i), Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i),Mesh(16,i), &
                       Mesh(17,i),Mesh(18,i),Mesh(19,i),Mesh(20,i), &
        ...
        write (ice_stdout,*) "A Level 2 Cinco Curve:"
        write (ice_stdout,*) "------------------------------------------"
        do i=1,gridsize
           write(ice_stdout,25) Mesh(1,i), Mesh(2,i), Mesh(3,i), Mesh(4,i), &
                       Mesh(5,i), Mesh(6,i), Mesh(7,i), Mesh(8,i), &
                       Mesh(9,i), Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i),Mesh(16,i), &
                       Mesh(17,i),Mesh(18,i),Mesh(19,i),Mesh(20,i), &
        ...
        write (ice_stdout,*) "A Level 3 Peano Meandering Curve:"
        write (ice_stdout,*) "---------------------------------"
        do i=1,gridsize
           write(ice_stdout,27) Mesh(1,i), Mesh(2,i), Mesh(3,i), Mesh(4,i), &
                       Mesh(5,i), Mesh(6,i), Mesh(7,i), Mesh(8,i), &
                       Mesh(9,i), Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i),Mesh(16,i), &
                       Mesh(17,i),Mesh(18,i),Mesh(19,i),Mesh(20,i), &
        ...
        write (ice_stdout,*) "A Level 5 Hilbert Curve:"
        write (ice_stdout,*) "------------------------"
        do i=1,gridsize
           write(ice_stdout,32) Mesh(1,i), Mesh(2,i), Mesh(3,i), Mesh(4,i),  &
                       Mesh(5,i), Mesh(6,i), Mesh(7,i), Mesh(8,i),  &
                       Mesh(9,i), Mesh(10,i),Mesh(11,i),Mesh(12,i), &
                       Mesh(13,i),Mesh(14,i),Mesh(15,i),Mesh(16,i), &
                       Mesh(17,i),Mesh(18,i),Mesh(19,i),Mesh(20,i), &
...
!-----------------------------------------------------------------------
   ...
   if (verbose) then
      write(ice_stdout,*) subname,'chk1',dim,gridsize
      write(ice_stdout,*) subname,'chk2',level
